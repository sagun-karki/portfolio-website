...
- **CSS Architecture**: Refer to `.agent/css_structure.md` for details on how CSS files are modularized in `api/static/css/`. Edit the modular CSS files (not `styles.css`). Stylesheets are linked directly from templates.
